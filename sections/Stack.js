    ...
    return (
      <View style={styles.container}>
        ...
        <Button
          ...
          onPress={() => this.props.navigation.navigate('D', { canGoBack: true })}
        />
...
class ScreenC extends React.Component {
  static navigationOptions = ({ navigation }) => {
    let headerHidden = navigation.getParam('headerHidden', false);
...
class ScreenD extends React.Component {
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      title: navigation.getParam('userId', 'no user id provided!').toString(),
  ...
  render() {
    let canGoBack = this.props.navigation.state?.canGoBack || '';
